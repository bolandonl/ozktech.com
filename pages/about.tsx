          ...
          <div className="text-lg flex justify-center">
            <div className="text-stone-700 dark:text-quicksilver flex-col justify-center">
              <div className="text-left space-y-6 max-w-3xl">
                <p>
                  <span className="ml-6">After</span> moving to the Ozarks at the start of 2022, I
                  made random Google searches to explore the area&apos;s tech scene. I was happy to
                ...
                <p>
                  <span className="ml-6">I</span> decided to build ozktech.com - a simple way to
                  find tech companies and jobs in the Ozarks. What started as a random Notes
